            ...
            Card(
                ...
                Column(
                    ...
                    Row(modifier = Modifier.fillMaxWidth()) {
                        ActionIcon.entries.fastForEachIndexed { index, actionIcon ->
                            CustomActionButton(
...
private enum class ActionIcon(val icon: ImageVector, val contentDescription: String) {
    BookMark(icon = Icons.Default.FavoriteBorder, "BookMark"),
    Share(icon = Icons.Default.Share, "Share"),
    Download(icon = Icons.Default.KeyboardArrowDown, "Download"),
