...
import com.example.myapplication.ui.detail.component.DetailBodyContent
import com.example.myapplication.ui.detail.component.DetailTopContent
...
fun MovieDetailScreen(
    ...
    Box(modifier = modifier.fillMaxWidth()){
        ...
        AnimatedVisibility(visible = !state.isMovieLoading && state.error == null) {
            BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
                ...
                state.movieDetail?.let { movieDetail ->
                    ...
                    DetailBodyContent(
                        ...
                        fetchMovie =movieDetailViewModel::fetchMovie,
